...
void pick(moveit::planning_interface::MoveGroup &group){
 ...
 std::cout << "print_aux: " << group.getEndEffector() << std::endl;
...
int main(int argc, char *argv[]){
 ...
 std::cout << "End effector: " << group.getEndEffector() << std::endl;
 std::cout << "End effector link: " << group.getEndEffectorLink() << std::endl;
 ...
 aco.link_name = "arm_link_tool0";
 aco.object = co;
 pub_aco.publish(aco);

 // co.operation = moveit_msgs::CollisionObject::ADD;
 co.primitives[0].dimensions[shape_msgs::SolidPrimitive::BOX_X] = 0.15;
 co.primitives[0].dimensions[shape_msgs::SolidPrimitive::BOX_Y] = 0.005;
