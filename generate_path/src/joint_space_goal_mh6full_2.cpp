...
*/
 group_variable_values[0] = 0.0;//-0.22;
 group_variable_values[1] = 0.0;//0.6622;
 group_variable_values[2] = 0.0;//-0.2204;
 group_variable_values[3] = 0.0;//0.3083;
 group_variable_values[4] = 0.0;//0.6105;
 group_variable_values[5] = 0.0;//0.7549;
 group_variable_values[6] = 0.0;//0.4815;
